...
(function ($) {
    ...
    $(function () {
        ...
        window.wprsync_do_sync = function (e, path) {
            ...
            $.magnificPopup.open({
                ...
                callbacks: {
                    ajaxContentAdded: function ajaxContentAdded() {
                        data.force = true;
                        var $container = $('#wprsync-popup');
                        var $sync_now = $container.find('button#sync-now');
                        $sync_now.on('click', function () {
                            $container.addClass('loading');
                            $container.parent().load(ajaxurl + '?' + $.param(data), function () {
                                $container = $('#wprsync-popup');
                                var new_date = $('#wprsync-popup').find('#new-latest-sync-date').text();
                                var new_version = $('#wprsync-popup').find('#new-latest-sync-version').text();
